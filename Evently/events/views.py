...
class EventViewSet(viewsets.ViewSet):
    ...
    def user_events(self, request):
        """GET /api/events/user/ - Get events for the current user"""
    ...
    def approve_event(self, request):
        ...
        try:
            ...
            return Response({"message": "Участь підтверджено, нагадування заплановано"}, status=200)

        except EventUser.DoesNotExist:
            return Response({"error": "Користувач не зараєстрован на цю подію"}, status=404)
